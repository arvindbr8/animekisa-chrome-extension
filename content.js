...
function showNotificationBar(message, nextEpisode) {

    /*set default values*/
    duration = typeof duration !== 'undefined' ? duration : 3000;
    bgColor = typeof bgColor !== 'undefined' ? bgColor : "#eabf61";
    txtColor = typeof txtColor !== 'undefined' ? txtColor : "#9e7215";
    height = typeof height !== 'undefined' ? height : 50;
    borderColor = '#eabf61'
    /*create the notification bar div if it doesn't exist*/
    if ($('#notification-bar').length == 0) {
        var HTMLmessage = "<div class='notification-message' style='text-align:left; font-family:myriad; line-height: " + height + "px; padding:1px 20px;'>" + message + `<a style="line-height: ${height}px;" href="${window.location.href.replace(episodeNo, nextEpisode)}"> Go to </a> next canon` + "</div>";
